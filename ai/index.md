...
- You are expected to adhere to the principles of academic integrity of TU Delft:
  - [TU Delft Integrity Portal](https://integrity.tudelft.nl)
...
- A **detailed disclosure statement** is mandatory. The MSc Geomatics for the Built Environment thesis template has an [Appendix](https://github.com/tudelft3d/msc_geomatics_thesis_template/blob/main/appendices/useofai.tex) to help you start.
